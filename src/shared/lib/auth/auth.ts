...
export const auth = betterAuth({
	...
	// rateLimit: {
	// 	enabled: true, // Принудительно включаем (полезно для тестов в dev-режиме)
	// 	window: 60,    // Временное окно в секундах (например, 1 минута)
	// 	max: 2,      // Максимально 5 запросов за указанное окно с одного IP
	// },
